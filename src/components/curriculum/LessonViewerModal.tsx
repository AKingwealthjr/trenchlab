...
export const LessonViewerModal: React.FC<LessonViewerModalProps> = ({
  ...
  const primaryVideo = lesson.videos && lesson.videos.length > 0 ? lesson.videos[0] : null;
            ...
            <div className="bg-[#0A0A0B] border border-[#242429] rounded-xl overflow-hidden">
              <div className="aspect-video w-full bg-black relative">
                {primaryVideo.youtubeId ? (
                  <iframe
                    className="w-full h-full"
                    src={`https://www.youtube-nocookie.com/embed/${primaryVideo.youtubeId}?rel=0&modestbranding=1`}
                  ...
                  <div className="flex flex-col items-center justify-center h-full p-6 text-center space-y-3">
                    <Play className="w-12 h-12 text-[#E8A33D]" />
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 bg-[#E8A33D] text-[#0A0A0B] px-4 py-2 rounded-lg text-xs font-mono font-bold"
                    >
                      <span>WATCH ON YOUTUBE</span>
              ...
              {/* Video Info Bar */}
              <div className="p-3.5 bg-[#131316] border-t border-[#242429] flex flex-wrap items-center justify-between gap-2 text-xs font-mono">
                <div>
                  <span className="text-[#8E8E98]">RESOURCE: </span>
                  <span className="text-[#EDEDEF] font-medium">{primaryVideo.title}</span>
                  <span className="text-[#8E8E98] ml-2">by {primaryVideo.creator} ({primaryVideo.duration})</span>
                </div>
                <a
                  href={primaryVideo.url}
                  target="_blank"
